...
export async function generateMetadata({
  ...
  return {
    ...
    description: `Reserve a time for ${service.name} at our beauty atelier.`,
  };
}
    ...
    <section className="mx-auto max-w-7xl px-6 py-12 md:px-10 md:py-16">
      ...
      <header className="mt-6 max-w-3xl">
        ...
        <p className="mt-5 text-base leading-relaxed text-muted md:text-lg text-pretty">
          Pick a day and time, share a few details, and we&apos;ll forward your
          request to the clinic on WhatsApp. Your slot is held for 24h while we
          confirm.
        </p>
      </header>
