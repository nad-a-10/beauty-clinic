...
export function BookingFlow({ service }: Props) {
  ...
  function onSubmit(values: BookingFormValues) {
    if (!selectedSlotIso) {
      setSubmission({
        kind: "error",
        message: "Please pick a day and time before submitting.",
      });
      return;
    }
        ...
        <div className="space-y-5">
          <div>
            ...
            <p className="mt-1 text-sm text-muted">
              We&apos;ll send these to the clinic by WhatsApp so they can
              confirm.
            </p>
          </div>
    ...
    <div className="overflow-hidden rounded-[1.75rem] border border-line/60 bg-ivory shadow-soft">
      ...
      <div className="space-y-5 p-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <dd className="text-right font-medium text-charcoal">
              {slot ? (
                ...
                <span className="text-muted">Pick a slot</span>
              )}
            </dd>
          </div>
        </dl>
        ...
        <p className="text-center text-xs leading-relaxed text-muted">
          Your slot is held for 24h while the clinic confirms by WhatsApp.
        </p>
      </div>
    </div>
  );
    ...
    <div className="mx-auto max-w-2xl">
      <div className="overflow-hidden rounded-[2rem] bg-rose-500 p-10 text-white shadow-lift">
        ...
        <p className="mt-4 max-w-xl text-rose-50/90">
          ...
          below to open WhatsApp, then hit send. The clinic will confirm or
          reschedule shortly.
        </p>
